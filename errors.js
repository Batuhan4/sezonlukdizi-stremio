/**
 * SezonlukDizi Stremio Addon - Custom Error Classes
 * 
 * Provides structured error types for better error handling and user feedback.
 */

/**
 * Base error class for SezonlukDizi addon
 */
class SezonlukDiziError extends Error {
    /**
...
/**
 * Content not found on SezonlukDizi
 */
class ContentNotFoundError extends SezonlukDiziError {
    /**
    ...
    getUserMessage() {
        return `"${this.query}" SezonlukDizi'de bulunamadı.`;
    }
}
 ...
 */
class ScrapingError extends SezonlukDiziError {
    /**
 ...
 */
class NetworkError extends SezonlukDiziError {
    /**
     * @param {string} message - Error description
    ...
    getUserMessage() {
        ...
        if (this.statusCode >= 500) {
            return 'SezonlukDizi sunucusu geçici olarak kullanılamıyor.';
        }
 ...
 */
class ValidationError extends SezonlukDiziError {
    /**
 ...
 * Rate limiting error
 */
class RateLimitError extends SezonlukDiziError {
    /**
